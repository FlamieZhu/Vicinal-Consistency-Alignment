...
This source code is licensed under the terms reproduced in
LICENSES/CLASSIFIER_BALANCING.txt in the repository root.

Portions of the source code are from the OLTR project; its terms are
reproduced in LICENSES/OLTR.txt in the repository root. This modified
multi-expert version also derives from RIDE; see LICENSES/RIDE.txt.
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_experts, dropout=None, num_classes=1000, use_norm=False, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, share_layer3=False, returns_feat=True, s=30):
        self.inplanes = 64
