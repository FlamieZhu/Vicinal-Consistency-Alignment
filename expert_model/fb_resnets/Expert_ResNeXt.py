...
This modified multi-expert version also derives from RIDE; see
LICENSES/RIDE.txt in the repository root.
"""
...
class ResNext(nn.Module):
    ...
    def __init__(self, block, layers, num_experts, groups=1, width_per_group=64, dropout=None, num_classes=1000, use_norm=True, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, returns_feat=True, s=30):
        self.inplanes = 64
